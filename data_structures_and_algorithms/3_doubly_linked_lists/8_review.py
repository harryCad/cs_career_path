...
Using our Node class to hold the value and links between 1_nodes
Implementing a DoublyLinkedList class to handle external operations on the list, like adding and removing 1_nodes
...
Create a few 1_nodes and add them to both ends of a new doubly linked list
Remove your doubly linked list’s head or tail node
Print your list again — were the right 1_nodes removed?
