...
class HashMap:
    def __init__(self, size):
        ...
        self.array = [LinkedList() for s in range(self.array_size)]

    def hash(self, key):
        to_bytes = key.encode()
        hash_code = sum(to_bytes)
        return hash_code
...
new_hash = HashMap(5)
new_hash.assign("hello", "goodbye")
print(new_hash.retrieve("hello"))
print(new_hash.retrieve("goodbye"))
